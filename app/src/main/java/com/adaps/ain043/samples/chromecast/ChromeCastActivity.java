package com.adaps.ain043.samples.chromecast;
...
import com.adaps.ain043.samples.databinding.ActivityChromecastBinding;
...
/**
 * Created by ain043 on 3/14/2018 at 11:36 AM
 */

public class ChromeCastActivity extends AppCompatActivity {
    private ActivityChromecastBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_chromecast);
    ...
    private class MediaRouterCallback extends MediaRouter.Callback {
        ...
        public void onRouteUnselected(MediaRouter router, MediaRouter.RouteInfo info) {
            ...
            binding.btnConnect.setText(getString(R.string.play_video));
                    ...
                    .setResultCallback(new ResultCallback<RemoteMediaPlayer.MediaChannelResult>() {
                        ...
                        public void onResult(RemoteMediaPlayer.MediaChannelResult mediaChannelResult) {
                            if (mediaChannelResult.getStatus().isSuccess()) {
                                mVideoIsLoaded = true;
                                binding.btnConnect.setText(getString(R.string.pause_video));
                            }
                        }
                    });
        } catch (Exception e) {
    ...
    private void controlVideo() {
        ...
        if (mIsPlaying) {
            ...
            binding.btnConnect.setText(getString(R.string.resume_video));
        } else {
